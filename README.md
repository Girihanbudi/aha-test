...
<!-- SETUP PRISMA MODEL -->
https://simplernerd.com/next-auth-prisma-postgres/

PS D:\projects\aha-test> npx prisma init

npx prisma migrate dev --name init (use for development)
npx prisma db push (use for production)
