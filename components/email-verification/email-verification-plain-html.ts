const emailVerificationPlainHTML = (link: string, name: string): string => {
  const inlineCSSHTML = `
  <div style="
    border-radius: 25px;
    text-align: center;
  ...
  ">
      ...
      <div style="padding: 40px 25px 25px 25px;">
        <h3>Dear ${name}</h3>
        <p>
          Welcome to our services. We need to verify your email
...
export default emailVerificationPlainHTML
